                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <form action="{{ route('vendor.auto_reply_settings.update') }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="auto_reply_enabled"
                                            name="auto_reply_enabled" value="1" {{ old('auto_reply_enabled', $vendor->auto_reply_enabled ?? 0) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="auto_reply_after_hours"
                                        ...
                                        value="{{ old('auto_reply_after_hours', $vendor->auto_reply_after_hours ?? 2) }}"
                                        placeholder="2">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="auto_reply_message" name="auto_reply_message" rows="5"
                                        placeholder="{{ __('Leave blank to use default: "Thank you for your inquiry. We have received your message and will get back to you as soon as possible."') }}">{{ old('auto_reply_message', $vendor->auto_reply_message ?? '') }}</textarea>
