    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @include('partials.social-credentials', [
                'social_credentials' => $admin->socialCredentials ?? null,
                'social_credentials_update_route' => 'admin.social_credentials.update',
            ])
            ...
            @include('partials.social-links', [
                'social_link' => $admin->socialLink ?? null,
                'social_links_update_route' => 'admin.social_links.update',
            ])
        </div>
    </div>
@endsection
